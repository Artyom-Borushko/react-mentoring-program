...
export default function MovieListPage() {
  ...
  const [selectedSortOption, setSelectedSortOption] = useState(
    BEtoFEMapMoviesSortingOptions(sortByQuery),
  );
  ...
  const genreSelectHandler = (userSelectedGenre) => {
    const params = new URLSearchParams(searchParams);
    if (userSelectedGenre && userSelectedGenre === 'all') {
      params.delete('filter');
    } else if (userSelectedGenre) {
      params.set('filter', userSelectedGenre);
    } else {
      params.delete('filter');
    }
    setSearchParams(params);
    setSelectedGenre(userSelectedGenre);
  };
  ...
  return (
    <>
      ...
      <div className="header-from-main-divider" />
